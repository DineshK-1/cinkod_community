    ...
    return (
        <>
            <div className="overflow-x-hidden relative bg-[#121212]">
                ...
                <div className=" relative flex justify-center items-center h-screen ">
                    ...
                    <div className="container w-4/5 h-1/2 lg:w-2/3">
                        <div className="w-full h-full text-white flex flex-col gap-4 items-center justify-start  ">
                            <h1 className="block text-5xl mt-4 ">
                                {" "}
                                Lorem ipsum{" "}
                            </h1>
                            ...
                            <p className=" block text-lg text-center mt-6">
                                ...
                                molestias maxime omnis, eveniet velit eaque
                                ullam saepe, amet accusamus rem! Illo,
                                accusantium numquam?
                            </p>
                ...
                <div className="relative flex justify-center items-center h-full lg:h-screen pb-10 mt-5">
                    ...
                    <div className="flex container mx-auto flex-col items-center h-full lg:ml-72 mt-[17rem] mb-28  ">
                        <div className="flex h-3/4 mb-16">
                            ...
                            <p className="block text-white text-lg mr-2 ml-8 text-justify mt-16 w-[55%]">
                                Lorem ipsum dolor sit, amet consectetur
                                adipisicing elit. Similique assumenda nesciunt
                                ipsam vel exercitationem nisi deserunt maiores
                                quae debitis ea magnam doloremque provident enim
                                possimus, laborum cupiditate beatae cumque magni
                                dicta voluptatem vero. Fugit?Lorem ipsum dolor
                                sit amet consectetur adipisicing elit.
                                Reprehenderit minima, ducimus tempore ex odit
                                illo voluptates corrupti facere dolorum harum,
                                incidunt error? Ipsa.
                            </p>
                        </div>
